...
public class RepeaterModule implements Module, ModuleLifecycle {
    ...
    public void onLoad() throws Throwable {
        log.info("RepeaterModule.onLoad method is start");
        // 初始化日志框架
    ...
    public void onUnload() throws Throwable {
        log.info("RepeaterModule.onUnload method is start");
    ...
    public void loadCompleted() {
        log.info("RepeaterModule.loadCompleted method is start");
    ...
    private synchronized void initialize(RepeaterConfig config) {
        log.info("RepeaterModule.initialize method is start RepeaterConfig参数：{}", JSONObject.toJSONString(config));
