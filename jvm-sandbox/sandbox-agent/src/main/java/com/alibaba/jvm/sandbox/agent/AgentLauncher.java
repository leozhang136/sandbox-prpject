...
public class AgentLauncher {
    ...
    public static final String CLASS_OF_CORE_CONFIGURE1 = CLASS_OF_CORE_CONFIGURE;
    ...
    public static void premain(String featureString, Instrumentation inst) {
        System.out.println("启动加载 premain: featureString = "+ featureString+ " inst = "+inst);
    ...
    public static void agentmain(String featureString, Instrumentation inst) {
        System.out.println("动态加载 agentmain: featureString = "+ featureString+ " inst = "+inst);
    ...
    private static synchronized void writeAttachResult(final String namespace,
        ...
        System.out.println("attach的结果："+ file.getAbsolutePath());
        if (file.exists()
                && (!file.isFile()
                || !file.canWrite())) {
    ...
    private static synchronized InetSocketAddress install(final Map<String, String> featureMap,
        ...
        System.out.println("coreFeatureString = " + coreFeatureString);
        ...
        try {
            ...
            System.out.println("将Spy注入到BootstrapClassLoader" + getSandboxSpyJarPath(home));
            ...
            System.out.println("构造自定义的类加载器" + getSandboxCoreJarPath(home));
            // CoreConfigure类定义
            final Class<?> classOfConfigure = sandboxClassLoader.loadClass(CLASS_OF_CORE_CONFIGURE1);
            System.out.println("内核启动配置类 "+classOfConfigure);
            ...
            // CoreServer类定义
            final Class<?> classOfProxyServer = sandboxClassLoader.loadClass(CLASS_OF_PROXY_CORE_SERVER);
            System.out.println("CoreServer类 "+classOfProxyServer);
            ...
            System.out.println("CoreServer.isBind "+ isBind);
