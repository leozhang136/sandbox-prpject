...
public class CoreLauncher {
    ...
    public static void main(String[] args) {
        try {
            args = new String[3];
            args[0] = "15916";
            args[1] = "E:\\IdeaProjects\\github\\alibaba\\jvm-sandbox\\sandbox-agent\\target\\sandbox-agent-1.3.3-jar-with-dependencies.jar";
            args[1] = "E:\\IdeaProjects\\github\\alibaba\\jvm-sandbox\\lib\\sandbox-agent.jar";
            args[2] = "home=E:\\IdeaProjects\\github\\alibaba\\jvm-sandbox;token=232341522729;server.ip=0.0.0.0;server.port=0;namespace=default";
            // check args
            if (args.length != 3
            ...
            System.out.println("内核启动程序 启动完成");
        } catch (Throwable t) {
